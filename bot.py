...
def send_fallback(message):
    text = "ကျွန်တော်က ငွေစျေးတွက်ပေးတဲ့ bot ဖြစ်ပါတယ် တခြားအကြောင်းအရာတွေ မဖြေဆိုနိုင်ပါခင်ဗျာ ငွေစျေး အသေးစိတ်သိလိုပါက Admin ကို တိုက်ရိုက်ဆက်သွယ်နိုင်ပါတယ်ခင်ဗျာ \n\nအသုံးပြုပုံ လမ်းညွှန် \n\n🇲🇲 ကျပ်ငွေလိုချင်ပါက \n[ဘတ်ပေး ပမာဏ သို့မဟုတ် ကျပ်ယူ ပမာဏ ရေးပါ]\nဥပမာ (ဘတ်ပေး 1000 ဘတ်) သို့မဟုတ် (ကျပ်ယူ 1သိန်းကျပ်) \n\n🇹🇭 ဘတ်ငွေလိုချင်ပါက [ကျပ်ပေး ပမာဏ သို့မဟုတ် ဘတ်ယူ ပမာဏ ရေးပါ]\nဥပမာ (ကျပ်ပေး 1သိန်းကျပ်) သို့မဟုတ် (ဘတ်ယူ 1000 ဘတ်) \n\nလိုချင်သော ပမာဏကို ပြင်ပြီး တွက်ချက်နိုင်ပါသည်။"
...
def menu_rate(message):
    ...
    if data:
        ...
        text = (f"📅 <b>ယခုငွေဈေး</b>\n\n"
                f"🇹🇭➡️🇲🇲 <b>ဘတ်ပေးကျပ်ယူ (1 သိန်းကျပ်)</b> = {th_rate} ဘတ်\n"
                f"🇲🇲➡️🇹🇭 <b>ကျပ်ပေးဘတ်ယူ (1 သိန်းကျပ်)</b> = {mm_rate} ဘတ်\n\n"
                f"<b>Kpay|WavePay|ဘဏ်အကောင့်အားလုံး ပေါက်စျေးအတိုင်းရပါတယ်</b>\n"
                f"<b>Wave password(ဆိုင်ထုတ်) ဝန်ဆောင်ခ 15 ဘတ်</b>\n"
                f"<b>ဘဏ်မှတ်ပုံတင်ထုတ် ဝန်ဆောင်ခ 5ဘတ်</b>\n"
                f"🇹🇭➡️🇲🇲 <b>ကျပ်ယူ 1သိန်းကျပ်အောက် ဖြစ်ပါက</b> ဖုန်းဘေစျေးနှုန်းအတိုင်း တွက်ပါတယ်\n")
...
def menu_help(message):
    text = (
        ...
        "🇲🇲 <b>ကျပ်ငွေလိုချင်ပါက [ဘတ်ပေး ပမာဏ သို့မဟုတ် ကျပ်ယူ ပမာဏ ကြိုက်တာရေးပါ]</b>\n"
        "ဥပမာ <code>(ဘတ်ပေး 1000 ဘတ်)</code> သို့မဟုတ် <code>(ကျပ်ယူ 1သိန်းကျပ်)</code>\n\n"
        "🇹🇭 <b>ဘတ်ငွေလိုချင်ပါက [ကျပ်ပေး ပမာဏ သို့မဟုတ် ဘတ်ယူ ပမာဏ ကြိုက်တာရေးပါ]</b>\n"
        "• <code>(ကျပ်ပေး 1သိန်းကျပ်)</code> သို့မဟုတ် <code>(ဘတ်ယူ 1000 ဘတ်)</code>\n\n"
        "လိုချင်သော ပမာဏကို တိုက်ရိုက်ရိုက်ထည့်၍လည်း တွက်ချက်နိုင်ပါသည်။"
    )
    bot.reply_to(message, text, parse_mode='HTML')
