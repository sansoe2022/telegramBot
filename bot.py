...
def send_fallback(message):
    text = (
        "<b>ကျွန်တော်က ငွေစျေးတွက်ပေးတဲ့ bot ဖြစ်ပါတယ် တခြားအကြောင်းအရာတွေ မဖြေဆိုနိုင်ပါခင်ဗျာ ငွေစျေး အသေးစိတ်သိလိုပါက Admin ကို တိုက်ရိုက်ဆက်သွယ်နိုင်ပါတယ်ခင်ဗျာ @sansoe2021</b>\n\n"
...
def menu_rate(message):
    ...
    if data:
        ...
        text = (f"📅 <b>ယခုငွေဈေး</b>\n\n"
                f"🇹🇭➡️🇲🇲 <b>ဘတ်ပေးကျပ်ယူ \n(1 သိန်းကျပ်) = {th_rate} ဘတ်</b>\n\n"
                f"🇲🇲➡️🇹🇭 <b>ကျပ်ပေးဘတ်ယူ \n(1 သိန်းကျပ်) = {mm_rate} ဘတ်</b>\n\n\n\n"
                f"ဝန်ဆောင်ခများ👇👇👇\n\n"
                f"Kpay|WavePay|ဘဏ်အကောင့်အားလုံး \nပေါက်စျေးအတိုင်းရပါတယ်\n\n"
                f"Wave password(ဆိုင်ထုတ်) \n1သိန်းကျပ် ဝန်ဆောင်ခ 15 ဘတ်\n\n"
                f"ဘဏ်မှတ်ပုံတင်ထုတ် 1သိန်းကျပ် ဝန်ဆောင်ခ 5ဘတ်\n\n"
...
def analyze_message(message):
    ...
    # Wave Password Detection
    keywords_wave = ['wave password', 'wave pw', 'wave ဆိုင်ထုတ်', 'wave pass']
    is_wave_pass = any(k in msg_lower for k in keywords_wave)
    ...
    if is_wave_pass:
        ...
        result_text = (f"{input_show} ရောင်းရင်\n"
                       f"🇲🇲 <b>{mmk_clean:,.0f} Ks</b> ရပါမယ်ခင်ဗျာ။\n"
                       f"(Rate: {wave_rate})")
    ...
    # SCENARIO A: INPUT IS BAHT (User types "5000 B" or "ဘတ်ပေး 5000")
        ...
        if user_wants_thb and not user_wants_mmk:
            ...
            elif approx_mmk_cost >= 1000000: rate += 2 
